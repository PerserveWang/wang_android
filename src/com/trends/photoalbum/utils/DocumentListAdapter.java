...
public class DocumentListAdapter extends BaseAdapter {
	...
	public DocumentListAdapter(Context context, ArrayList<WizDocument> docList,
			String tagGuid) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.article_style, null);
		...
		if ((position % 2) == 0) {
			convertView.setBackgroundResource(color.gray);
		} else {
