...
public class DocumentListAdapter_OPUS extends BaseAdapter {
	...
	public DocumentListAdapter_OPUS(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.opus_style, null);
